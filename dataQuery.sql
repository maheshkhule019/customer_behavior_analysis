...
--Q2.which customers used a discount but still spent more than the avrage purchade amunt?
select customer_id, purchase_amount
from customer
where discount_applied = 'Yes' and purchase_amount >= (select AVG(purchase_amount) from customer)

--Q3 which are the top five product with the highest avg review rating
...
--Q.5 Do subscribe customers spend more? Compare average spend 
--and total revenue between subscribers.
